...
export default function QrcodeReaderComponent() {
    ...
    const fetchAndSetTrade = async (buyTime: Date) => {
        ...
        const response = await fetch('https://tech0-gen-5-step4-studentwebapp-1.azurewebsites.net/trade', {
            method: 'POST',
            headers: {
    ...
    const fetchAndDealDetail = async (buyTime: Date) => {
        ...
        const response = await fetch('https://tech0-gen-5-step4-studentwebapp-1.azurewebsites.net/deal_detail', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
